...
class ServiceException extends IsasException
{
    ...
    private $httpStatusCode; // HTTP 状态码（如 400, 403, 500）
    private $responseBody;   // 服务器返回的原始数据（通常是 JSON 字符串，甚至是报错的 HTML）
     ...
     */
    public function __construct($message, $code = 0, $httpStatusCode = 0, $responseBody = null)
    {
